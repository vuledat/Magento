<?php
namespace Simi\Simiconnector\Model\ResourceModel\Productlist\ProductlistCollection;

/**
 * Interceptor class for @see \Simi\Simiconnector\Model\ResourceModel\Productlist\ProductlistCollection
 */
class Interceptor extends \Simi\Simiconnector\Model\ResourceModel\Productlist\ProductlistCollection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getProductCollection($listModel, $simiObjectManager)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductCollection($listModel, $simiObjectManager);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductCollectionByType');
        if (!$pluginInfo) {
            return parent::getProductCollectionByType($type, $simiObjectManager, $listProduct);
        } else {
            return $this->___callPlugins('getProductCollectionByType', func_get_args(), $pluginInfo);
        }
    }
