<?php
namespace Simi\Simiconnector\Model\ResourceModel\Cms\Collection;

/**
 * Interceptor class for @see \Simi\Simiconnector\Model\ResourceModel\Cms\Collection
 */
class Interceptor extends \Simi\Simiconnector\Model\ResourceModel\Cms\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'applyAPICollectionFilter');
        if (!$pluginInfo) {
            return parent::applyAPICollectionFilter($visibilityTable, $typeID, $storeID);
        } else {
            return $this->___callPlugins('applyAPICollectionFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryCMSPages');
        if (!$pluginInfo) {
            return parent::getCategoryCMSPages($visibilityTable, $typeID, $storeID);
        } else {
            return $this->___callPlugins('getCategoryCMSPages', func_get_args(), $pluginInfo);
        }
    }
