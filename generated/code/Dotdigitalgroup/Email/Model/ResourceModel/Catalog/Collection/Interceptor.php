<?php
namespace Dotdigitalgroup\Email\Model\ResourceModel\Catalog\Collection;

/**
 * Interceptor class for @see \Dotdigitalgroup\Email\Model\ResourceModel\Catalog\Collection
 */
class Interceptor extends \Dotdigitalgroup\Email\Model\ResourceModel\Catalog\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Data\Collection\EntityFactoryInterface $entityFactory, \Psr\Log\LoggerInterface $logger, \Magento\Framework\Data\Collection\Db\FetchStrategyInterface $fetchStrategy, \Magento\Framework\Event\ManagerInterface $eventManager, \Dotdigitalgroup\Email\Helper\Data $helper, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollection, \Magento\Framework\DB\Adapter\AdapterInterface $connection = null, \Magento\Framework\Model\ResourceModel\Db\AbstractDb $resource = null)
    {
        $this->___init();
        parent::__construct($entityFactory, $logger, $fetchStrategy, $eventManager, $helper, $productCollection, $connection, $resource);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsToExportByStore');
        if (!$pluginInfo) {
            return parent::getProductsToExportByStore($store, $limit, $modified);
        } else {
            return $this->___callPlugins('getProductsToExportByStore', func_get_args(), $pluginInfo);
        }
    }
