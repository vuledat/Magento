...
class Interceptor extends \Magento\Authorizenet\Model\Directpost implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDataHelper');
        if (!$pluginInfo) {
            return parent::setDataHelper($dataHelper);
        } else {
            return $this->___callPlugins('setDataHelper', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCgiUrl');
        if (!$pluginInfo) {
            return parent::getCgiUrl();
        } else {
            return $this->___callPlugins('getCgiUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRelayUrl');
        if (!$pluginInfo) {
            return parent::getRelayUrl($storeId);
        } else {
            return $this->___callPlugins('getRelayUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'generateRequestFromOrder');
        if (!$pluginInfo) {
            return parent::generateRequestFromOrder($order);
        } else {
            return $this->___callPlugins('generateRequestFromOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setResponseData(array $postData)
    {
        ...
        if (!$pluginInfo) {
            return parent::setResponseData($postData);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'validateResponse');
        if (!$pluginInfo) {
            return parent::validateResponse();
        } else {
            return $this->___callPlugins('validateResponse', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checkResponseCode');
        if (!$pluginInfo) {
            return parent::checkResponseCode();
        } else {
            return $this->___callPlugins('checkResponseCode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checkTransId');
        if (!$pluginInfo) {
            return parent::checkTransId();
        } else {
            return $this->___callPlugins('checkTransId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsInitializeNeeded');
        if (!$pluginInfo) {
            return parent::setIsInitializeNeeded($isInitializeNeeded);
        } else {
            return $this->___callPlugins('setIsInitializeNeeded', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAcceptedCurrencyCodes');
        if (!$pluginInfo) {
            return parent::getAcceptedCurrencyCodes();
        } else {
            return $this->___callPlugins('getAcceptedCurrencyCodes', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'fetchTransactionFraudDetails');
        if (!$pluginInfo) {
            return parent::fetchTransactionFraudDetails($transactionId);
        } else {
            return $this->___callPlugins('fetchTransactionFraudDetails', func_get_args(), $pluginInfo);
        }
    }
