...
class Interceptor extends \Magento\Security\Model\ResourceModel\AdminSessionInfo\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
     ...
     * {@inheritdoc}
     */
    public function updateActiveSessionsStatus($status, $userId, $sessionIdToExclude, $updateOlderThen = null)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'updateActiveSessionsStatus');
        if (!$pluginInfo) {
            return parent::updateActiveSessionsStatus($status, $userId, $sessionIdToExclude, $updateOlderThen);
        } else {
            return $this->___callPlugins('updateActiveSessionsStatus', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function filterByUser($userId, $status = 1, $sessionIdToExclude = null)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByUser');
        if (!$pluginInfo) {
            return parent::filterByUser($userId, $status, $sessionIdToExclude);
        } else {
            return $this->___callPlugins('filterByUser', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterExpiredSessions');
        if (!$pluginInfo) {
            return parent::filterExpiredSessions($sessionLifeTime);
        } else {
            return $this->___callPlugins('filterExpiredSessions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'deleteSessionsOlderThen');
        if (!$pluginInfo) {
            return parent::deleteSessionsOlderThen($timestamp);
        } else {
            return $this->___callPlugins('deleteSessionsOlderThen', func_get_args(), $pluginInfo);
        }
    }
