...
class Interceptor extends \Magento\Customer\Model\ResourceModel\Address\Attribute\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setEntityTypeFilter($type)
    {
        ...
        if (!$pluginInfo) {
            return parent::setEntityTypeFilter($type);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSystemHiddenFilter');
        if (!$pluginInfo) {
            return parent::addSystemHiddenFilter();
        } else {
            return $this->___callPlugins('addSystemHiddenFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSystemHiddenFilterWithPasswordHash');
        if (!$pluginInfo) {
            return parent::addSystemHiddenFilterWithPasswordHash();
        } else {
            return $this->___callPlugins('addSystemHiddenFilterWithPasswordHash', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addExcludeHiddenFrontendFilter');
        if (!$pluginInfo) {
            return parent::addExcludeHiddenFrontendFilter();
        } else {
            return $this->___callPlugins('addExcludeHiddenFrontendFilter', func_get_args(), $pluginInfo);
        }
    }
