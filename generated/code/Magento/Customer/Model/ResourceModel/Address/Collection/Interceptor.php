...
class Interceptor extends \Magento\Customer\Model\ResourceModel\Address\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setCustomerFilter');
        if (!$pluginInfo) {
            return parent::setCustomerFilter($customer);
        } else {
            return $this->___callPlugins('setCustomerFilter', func_get_args(), $pluginInfo);
        }
    }
