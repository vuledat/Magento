...
class Interceptor extends \Magento\Customer\Model\ResourceModel\Group\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIgnoreIdFilter');
        if (!$pluginInfo) {
            return parent::setIgnoreIdFilter($indexes);
        } else {
            return $this->___callPlugins('setIgnoreIdFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setRealGroupsFilter');
        if (!$pluginInfo) {
            return parent::setRealGroupsFilter();
        } else {
            return $this->___callPlugins('setRealGroupsFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTaxClass');
        if (!$pluginInfo) {
            return parent::addTaxClass();
        } else {
            return $this->___callPlugins('addTaxClass', func_get_args(), $pluginInfo);
        }
    }
