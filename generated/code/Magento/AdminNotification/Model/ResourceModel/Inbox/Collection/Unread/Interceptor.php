...
class Interceptor extends \Magento\AdminNotification\Model\ResourceModel\Inbox\Collection\Unread implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRemoveFilter');
        if (!$pluginInfo) {
            return parent::addRemoveFilter();
        } else {
            return $this->___callPlugins('addRemoveFilter', func_get_args(), $pluginInfo);
        }
    }
