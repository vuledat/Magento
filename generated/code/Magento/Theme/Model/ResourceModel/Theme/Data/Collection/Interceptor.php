...
class Interceptor extends \Magento\Theme\Model\ResourceModel\Theme\Data\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addParentTitle()
    {
        ...
        if (!$pluginInfo) {
            return parent::addParentTitle();
        } else {
            return $this->___callPlugins('addParentTitle', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addAreaFilter($area = 'frontend')
    {
        ...
        if (!$pluginInfo) {
            return parent::addAreaFilter($area);
        } else {
            return $this->___callPlugins('addAreaFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addTypeRelationFilter($typeParent, $typeChild)
    {
        ...
        if (!$pluginInfo) {
            return parent::addTypeRelationFilter($typeParent, $typeChild);
        } else {
            return $this->___callPlugins('addTypeRelationFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addTypeFilter($type)
    {
        ...
        if (!$pluginInfo) {
            return parent::addTypeFilter($type);
        } else {
            return $this->___callPlugins('addTypeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getThemeByFullPath($fullPath)
    {
        ...
        if (!$pluginInfo) {
            return parent::getThemeByFullPath($fullPath);
        } else {
            return $this->___callPlugins('getThemeByFullPath', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function updateChildRelations(\Magento\Framework\View\Design\ThemeInterface $themeModel)
    {
        ...
        if (!$pluginInfo) {
            return parent::updateChildRelations($themeModel);
        } else {
            return $this->___callPlugins('updateChildRelations', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function filterPhysicalThemes($page = null, $pageSize = 6)
    {
        ...
        if (!$pluginInfo) {
            return parent::filterPhysicalThemes($page, $pageSize);
        } else {
            return $this->___callPlugins('filterPhysicalThemes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function filterThemeCustomizations($area = 'frontend', $type = 1)
    {
        ...
        if (!$pluginInfo) {
            return parent::filterThemeCustomizations($area, $type);
        } else {
            return $this->___callPlugins('filterThemeCustomizations', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLabels()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getLabels', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function loadRegisteredThemes()
    {
        ...
        if (!$pluginInfo) {
            return parent::loadRegisteredThemes();
        } else {
            return $this->___callPlugins('loadRegisteredThemes', func_get_args(), $pluginInfo);
        }
    }
