...
class Interceptor extends \Magento\Authorization\Model\ResourceModel\Role\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setUserFilter');
        if (!$pluginInfo) {
            return parent::setUserFilter($userId, $userType);
        } else {
            return $this->___callPlugins('setUserFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setRolesFilter');
        if (!$pluginInfo) {
            return parent::setRolesFilter();
        } else {
            return $this->___callPlugins('setRolesFilter', func_get_args(), $pluginInfo);
        }
    }
