...
class Interceptor extends \Magento\Authorization\Model\ResourceModel\Rules\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getByRoles');
        if (!$pluginInfo) {
            return parent::getByRoles($roleId);
        } else {
            return $this->___callPlugins('getByRoles', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSortByLength');
        if (!$pluginInfo) {
            return parent::addSortByLength();
        } else {
            return $this->___callPlugins('addSortByLength', func_get_args(), $pluginInfo);
        }
    }
