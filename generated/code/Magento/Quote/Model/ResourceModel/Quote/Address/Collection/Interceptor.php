...
class Interceptor extends \Magento\Quote\Model\ResourceModel\Quote\Address\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setQuoteFilter');
        if (!$pluginInfo) {
            return parent::setQuoteFilter($quoteId);
        } else {
            return $this->___callPlugins('setQuoteFilter', func_get_args(), $pluginInfo);
        }
    }
