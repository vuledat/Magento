...
class Interceptor extends \Magento\Quote\Model\ResourceModel\Quote\Item\Option\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addItemFilter');
        if (!$pluginInfo) {
            return parent::addItemFilter($item);
        } else {
            return $this->___callPlugins('addItemFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOptionsByItem');
        if (!$pluginInfo) {
            return parent::getOptionsByItem($item);
        } else {
            return $this->___callPlugins('getOptionsByItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getOptionsByProduct');
        if (!$pluginInfo) {
            return parent::getOptionsByProduct($product);
        } else {
            return $this->___callPlugins('getOptionsByProduct', func_get_args(), $pluginInfo);
        }
    }
