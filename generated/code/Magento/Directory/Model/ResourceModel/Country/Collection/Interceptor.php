...
class Interceptor extends \Magento\Directory\Model\ResourceModel\Country\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadByStore');
        if (!$pluginInfo) {
            return parent::loadByStore($store);
        } else {
            return $this->___callPlugins('loadByStore', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getItemById($countryId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getItemById($countryId);
        } else {
    ...
    public function addCountryCodeFilter($countryCode, $iso = array('iso3', 'iso2'))
    {
        ...
        if (!$pluginInfo) {
            return parent::addCountryCodeFilter($countryCode, $iso);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCountryIdFilter');
        if (!$pluginInfo) {
            return parent::addCountryIdFilter($countryId);
        } else {
            return $this->___callPlugins('addCountryIdFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setForegroundCountries');
        if (!$pluginInfo) {
            return parent::setForegroundCountries($foregroundCountries);
        } else {
            return $this->___callPlugins('setForegroundCountries', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCountriesWithRequiredStates');
        if (!$pluginInfo) {
            return parent::getCountriesWithRequiredStates();
        } else {
            return $this->___callPlugins('getCountriesWithRequiredStates', func_get_args(), $pluginInfo);
        }
    }
