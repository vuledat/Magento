...
class Interceptor extends \Magento\Directory\Model\ResourceModel\Region\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addAllowedCountriesFilter');
        if (!$pluginInfo) {
            return parent::addAllowedCountriesFilter($store);
        } else {
            return $this->___callPlugins('addAllowedCountriesFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCountryFilter');
        if (!$pluginInfo) {
            return parent::addCountryFilter($countryId);
        } else {
            return $this->___callPlugins('addCountryFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCountryCodeFilter');
        if (!$pluginInfo) {
            return parent::addCountryCodeFilter($countryCode);
        } else {
            return $this->___callPlugins('addCountryCodeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRegionCodeFilter');
        if (!$pluginInfo) {
            return parent::addRegionCodeFilter($regionCode);
        } else {
            return $this->___callPlugins('addRegionCodeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRegionNameFilter');
        if (!$pluginInfo) {
            return parent::addRegionNameFilter($regionName);
        } else {
            return $this->___callPlugins('addRegionNameFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRegionCodeOrNameFilter');
        if (!$pluginInfo) {
            return parent::addRegionCodeOrNameFilter($region);
        } else {
            return $this->___callPlugins('addRegionCodeOrNameFilter', func_get_args(), $pluginInfo);
        }
    }
