...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Category\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addIdFilter($categoryIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::addIdFilter($categoryIds);
        } else {
    ...
    public function setLoadProductCount($flag)
    {
        ...
        if (!$pluginInfo) {
            return parent::setLoadProductCount($flag);
        } else {
            return $this->___callPlugins('setLoadProductCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setProductStoreId($storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setProductStoreId($storeId);
        } else {
            return $this->___callPlugins('setProductStoreId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductStoreId()
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductStoreId();
        } else {
            return $this->___callPlugins('getProductStoreId', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function loadProductCount($items, $countRegular = true, $countAnchor = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::loadProductCount($items, $countRegular, $countAnchor);
        } else {
            return $this->___callPlugins('loadProductCount', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addPathFilter($regexp)
    {
        ...
        if (!$pluginInfo) {
            return parent::addPathFilter($regexp);
        } else {
            return $this->___callPlugins('addPathFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addIsActiveFilter()
    {
        ...
        if (!$pluginInfo) {
            return parent::addIsActiveFilter();
        } else {
    ...
    public function addNameToResult()
    {
        ...
        if (!$pluginInfo) {
            return parent::addNameToResult();
        } else {
            return $this->___callPlugins('addNameToResult', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addUrlRewriteToResult()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('addUrlRewriteToResult', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addPathsFilter($paths)
    {
        ...
        if (!$pluginInfo) {
            return parent::addPathsFilter($paths);
        } else {
            return $this->___callPlugins('addPathsFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addLevelFilter($level)
    {
        ...
        if (!$pluginInfo) {
            return parent::addLevelFilter($level);
        } else {
            return $this->___callPlugins('addLevelFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addRootLevelFilter()
    {
        ...
        if (!$pluginInfo) {
            return parent::addRootLevelFilter();
        } else {
            return $this->___callPlugins('addRootLevelFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addOrderField($field)
    {
        ...
        if (!$pluginInfo) {
            return parent::addOrderField($field);
        } else {
            return $this->___callPlugins('addOrderField', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductTable()
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductTable();
        } else {
            return $this->___callPlugins('getProductTable', func_get_args(), $pluginInfo);
        }
    }
