...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\ProductFrontendAction\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByUserIdentities');
        if (!$pluginInfo) {
            return parent::addFilterByUserIdentities($customerId, $visitorId);
        } else {
            return $this->___callPlugins('addFilterByUserIdentities', func_get_args(), $pluginInfo);
        }
    }
