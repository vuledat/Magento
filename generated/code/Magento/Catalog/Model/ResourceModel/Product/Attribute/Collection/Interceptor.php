...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Attribute\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function setEntityTypeFilter($typeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setEntityTypeFilter($typeId);
        } else {
            return $this->___callPlugins('setEntityTypeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'removePriceFilter');
        if (!$pluginInfo) {
            return parent::removePriceFilter();
        } else {
            return $this->___callPlugins('removePriceFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addDisplayInAdvancedSearchFilter');
        if (!$pluginInfo) {
            return parent::addDisplayInAdvancedSearchFilter();
        } else {
            return $this->___callPlugins('addDisplayInAdvancedSearchFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIsFilterableFilter');
        if (!$pluginInfo) {
            return parent::addIsFilterableFilter();
        } else {
            return $this->___callPlugins('addIsFilterableFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIsFilterableInSearchFilter');
        if (!$pluginInfo) {
            return parent::addIsFilterableInSearchFilter();
        } else {
            return $this->___callPlugins('addIsFilterableInSearchFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addVisibleFilter');
        if (!$pluginInfo) {
            return parent::addVisibleFilter();
        } else {
            return $this->___callPlugins('addVisibleFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIsSearchableFilter');
        if (!$pluginInfo) {
            return parent::addIsSearchableFilter();
        } else {
            return $this->___callPlugins('addIsSearchableFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addToIndexFilter');
        if (!$pluginInfo) {
            return parent::addToIndexFilter($addRequiredCodes);
        } else {
            return $this->___callPlugins('addToIndexFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addSearchableAttributeFilter');
        if (!$pluginInfo) {
            return parent::addSearchableAttributeFilter();
        } else {
            return $this->___callPlugins('addSearchableAttributeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIsUsedInGridFilter');
        if (!$pluginInfo) {
            return parent::addIsUsedInGridFilter();
        } else {
            return $this->___callPlugins('addIsUsedInGridFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function useLoadDataFields()
    {
        ...
        if (!$pluginInfo) {
            return parent::useLoadDataFields();
        } else {
            return $this->___callPlugins('useLoadDataFields', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setAttributeSetFilter($setId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAttributeSetFilter($setId);
        } else {
            return $this->___callPlugins('setAttributeSetFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setAttributeSetFilterBySetName($attributeSetName, $entityTypeCode)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAttributeSetFilterBySetName($attributeSetName, $entityTypeCode);
        } else {
            return $this->___callPlugins('setAttributeSetFilterBySetName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setAttributeSetsFilter(array $setIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAttributeSetsFilter($setIds);
        } else {
            return $this->___callPlugins('setAttributeSetsFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setInAllAttributeSetsFilter(array $setIds)
    {
        ...
        if (!$pluginInfo) {
            return parent::setInAllAttributeSetsFilter($setIds);
        } else {
            return $this->___callPlugins('setInAllAttributeSetsFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setAttributesExcludeFilter($attributes)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAttributesExcludeFilter($attributes);
        } else {
            return $this->___callPlugins('setAttributesExcludeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setExcludeSetFilter($setId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setExcludeSetFilter($setId);
        } else {
            return $this->___callPlugins('setExcludeSetFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setAttributeGroupFilter($groupId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAttributeGroupFilter($groupId);
        } else {
            return $this->___callPlugins('setAttributeGroupFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addAttributeGrouping()
    {
        ...
        if (!$pluginInfo) {
            return parent::addAttributeGrouping();
        } else {
            return $this->___callPlugins('addAttributeGrouping', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addIsUniqueFilter()
    {
        ...
        if (!$pluginInfo) {
            return parent::addIsUniqueFilter();
        } else {
            return $this->___callPlugins('addIsUniqueFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addIsNotUniqueFilter()
    {
        ...
        if (!$pluginInfo) {
            return parent::addIsNotUniqueFilter();
        } else {
            return $this->___callPlugins('addIsNotUniqueFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addHasOptionsFilter()
    {
        ...
        if (!$pluginInfo) {
            return parent::addHasOptionsFilter();
        } else {
            return $this->___callPlugins('addHasOptionsFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setFrontendInputTypeFilter($frontendInputType)
    {
        ...
        if (!$pluginInfo) {
            return parent::setFrontendInputTypeFilter($frontendInputType);
        } else {
            return $this->___callPlugins('setFrontendInputTypeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setCodeFilter($code)
    {
        ...
        if (!$pluginInfo) {
            return parent::setCodeFilter($code);
        } else {
            return $this->___callPlugins('setCodeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addStoreLabel($storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::addStoreLabel($storeId);
        } else {
            return $this->___callPlugins('addStoreLabel', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function joinLeft($table, $cond, $cols = '*')
    {
        ...
        if (!$pluginInfo) {
            return parent::joinLeft($table, $cond, $cols);
        } else {
            return $this->___callPlugins('joinLeft', func_get_args(), $pluginInfo);
        }
    }
