...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Option\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getOptions($storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::getOptions($storeId);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addTitleToResult');
        if (!$pluginInfo) {
            return parent::addTitleToResult($storeId);
        } else {
            return $this->___callPlugins('addTitleToResult', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addPriceToResult');
        if (!$pluginInfo) {
            return parent::addPriceToResult($storeId);
        } else {
            return $this->___callPlugins('addPriceToResult', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addValuesToResult($storeId = null)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('addValuesToResult', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductToFilter');
        if (!$pluginInfo) {
            return parent::addProductToFilter($product);
        } else {
            return $this->___callPlugins('addProductToFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getProductOptions($productId, $storeId, $requiredOnly = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::getProductOptions($productId, $storeId, $requiredOnly);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRequiredFilter');
        if (!$pluginInfo) {
            return parent::addRequiredFilter($required);
        } else {
            return $this->___callPlugins('addRequiredFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addIdsToFilter');
        if (!$pluginInfo) {
            return parent::addIdsToFilter($optionIds);
        } else {
            return $this->___callPlugins('addIdsToFilter', func_get_args(), $pluginInfo);
        }
    }
