...
class Interceptor extends \Magento\Catalog\Model\ResourceModel\Product\Link\Product\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setLinkModel');
        if (!$pluginInfo) {
            return parent::setLinkModel($linkModel);
        } else {
            return $this->___callPlugins('setLinkModel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsStrongMode');
        if (!$pluginInfo) {
            return parent::setIsStrongMode();
        } else {
            return $this->___callPlugins('setIsStrongMode', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLinkModel');
        if (!$pluginInfo) {
            return parent::getLinkModel();
        } else {
            return $this->___callPlugins('getLinkModel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addExcludeProductFilter');
        if (!$pluginInfo) {
            return parent::addExcludeProductFilter($products);
        } else {
            return $this->___callPlugins('addExcludeProductFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addProductFilter($products)
    {
        ...
        if (!$pluginInfo) {
            return parent::addProductFilter($products);
        } else {
            return $this->___callPlugins('addProductFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setRandomOrder');
        if (!$pluginInfo) {
            return parent::setRandomOrder();
        } else {
            return $this->___callPlugins('setRandomOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setGroupBy');
        if (!$pluginInfo) {
            return parent::setGroupBy($groupBy);
        } else {
            return $this->___callPlugins('setGroupBy', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setPositionOrder($dir = 'ASC')
    {
        ...
        if (!$pluginInfo) {
            return parent::setPositionOrder($dir);
        } else {
     ...
     * {@inheritdoc}
     */
    public function setAttributeSetIdOrder($dir = 'ASC')
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAttributeSetIdOrder');
        if (!$pluginInfo) {
            return parent::setAttributeSetIdOrder($dir);
        } else {
            return $this->___callPlugins('setAttributeSetIdOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinAttributes');
        if (!$pluginInfo) {
            return parent::joinAttributes();
        } else {
            return $this->___callPlugins('joinAttributes', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getLinkAttributes($type = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::getLinkAttributes($type);
        } else {
            return $this->___callPlugins('getLinkAttributes', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addLinkAttributeToFilter');
        if (!$pluginInfo) {
            return parent::addLinkAttributeToFilter($code, $condition);
        } else {
            return $this->___callPlugins('addLinkAttributeToFilter', func_get_args(), $pluginInfo);
        }
    }
