...
class Interceptor extends \Magento\Catalog\Pricing\Render\PriceBox implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'jsonEncode');
        if (!$pluginInfo) {
            return parent::jsonEncode($valueToEncode);
        } else {
            return $this->___callPlugins('jsonEncode', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getCanDisplayQty(\Magento\Catalog\Model\Product $product)
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCanDisplayQty');
        if (!$pluginInfo) {
            return parent::getCanDisplayQty($product);
        } else {
            return $this->___callPlugins('getCanDisplayQty', func_get_args(), $pluginInfo);
        }
    }
