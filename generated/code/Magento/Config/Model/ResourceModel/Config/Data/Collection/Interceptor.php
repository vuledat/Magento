...
class Interceptor extends \Magento\Config\Model\ResourceModel\Config\Data\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addScopeFilter($scope, $scopeId, $section)
    {
        ...
        if (!$pluginInfo) {
            return parent::addScopeFilter($scope, $scopeId, $section);
        } else {
            return $this->___callPlugins('addScopeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addPathFilter($section)
    {
        ...
        if (!$pluginInfo) {
            return parent::addPathFilter($section);
        } else {
    ...
    public function addValueFilter($value)
    {
        ...
        if (!$pluginInfo) {
            return parent::addValueFilter($value);
        } else {
            return $this->___callPlugins('addValueFilter', func_get_args(), $pluginInfo);
        }
    }
