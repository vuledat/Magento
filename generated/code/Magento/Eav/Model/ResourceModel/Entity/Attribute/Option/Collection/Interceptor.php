...
class Interceptor extends \Magento\Eav\Model\ResourceModel\Entity\Attribute\Option\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setAttributeFilter');
        if (!$pluginInfo) {
            return parent::setAttributeFilter($setId);
        } else {
            return $this->___callPlugins('setAttributeFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setStoreFilter($storeId = null, $useDefaultValue = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::setStoreFilter($storeId, $useDefaultValue);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIdFilter');
        if (!$pluginInfo) {
            return parent::setIdFilter($optionId);
        } else {
            return $this->___callPlugins('setIdFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setPositionOrder($dir = 'ASC', $sortAlpha = false)
    {
        ...
        if (!$pluginInfo) {
            return parent::setPositionOrder($dir, $sortAlpha);
        } else {
