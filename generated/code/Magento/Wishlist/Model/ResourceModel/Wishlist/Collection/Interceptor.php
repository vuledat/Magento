...
class Interceptor extends \Magento\Wishlist\Model\ResourceModel\Wishlist\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByCustomerId');
        if (!$pluginInfo) {
            return parent::filterByCustomerId($customerId);
        } else {
            return $this->___callPlugins('filterByCustomerId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'filterByCustomerIds');
        if (!$pluginInfo) {
            return parent::filterByCustomerIds($customerIds);
        } else {
            return $this->___callPlugins('filterByCustomerIds', func_get_args(), $pluginInfo);
        }
    }
