...
class Interceptor extends \Magento\Wishlist\Model\ResourceModel\Item\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addWishlistFilter');
        if (!$pluginInfo) {
            return parent::addWishlistFilter($wishlist);
        } else {
            return $this->___callPlugins('addWishlistFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerIdFilter');
        if (!$pluginInfo) {
            return parent::addCustomerIdFilter($customerId);
        } else {
            return $this->___callPlugins('addCustomerIdFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addStoreData()
    {
        ...
        if (!$pluginInfo) {
            return parent::addStoreData();
        } else {
            return $this->___callPlugins('addStoreData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'resetSortOrder');
        if (!$pluginInfo) {
            return parent::resetSortOrder();
        } else {
            return $this->___callPlugins('resetSortOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setVisibilityFilter');
        if (!$pluginInfo) {
            return parent::setVisibilityFilter($flag);
        } else {
            return $this->___callPlugins('setVisibilityFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setSalableFilter');
        if (!$pluginInfo) {
            return parent::setSalableFilter($flag);
        } else {
            return $this->___callPlugins('setSalableFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setInStockFilter');
        if (!$pluginInfo) {
            return parent::setInStockFilter($flag);
        } else {
            return $this->___callPlugins('setInStockFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addDaysInWishlist');
        if (!$pluginInfo) {
            return parent::addDaysInWishlist();
        } else {
            return $this->___callPlugins('addDaysInWishlist', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addDaysFilter');
        if (!$pluginInfo) {
            return parent::addDaysFilter($constraints);
        } else {
            return $this->___callPlugins('addDaysFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addProductNameFilter');
        if (!$pluginInfo) {
            return parent::addProductNameFilter($productName);
        } else {
            return $this->___callPlugins('addProductNameFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setOrderByProductName');
        if (!$pluginInfo) {
            return parent::setOrderByProductName($dir);
        } else {
            return $this->___callPlugins('setOrderByProductName', func_get_args(), $pluginInfo);
        }
    }
