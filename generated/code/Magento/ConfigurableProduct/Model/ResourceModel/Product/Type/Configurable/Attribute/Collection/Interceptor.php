...
class Interceptor extends \Magento\ConfigurableProduct\Model\ResourceModel\Product\Type\Configurable\Attribute\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'orderByPosition');
        if (!$pluginInfo) {
            return parent::orderByPosition($dir);
        } else {
            return $this->___callPlugins('orderByPosition', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_addAssociatedProductFilters');
        if (!$pluginInfo) {
            return parent::_addAssociatedProductFilters();
        } else {
            return $this->___callPlugins('_addAssociatedProductFilters', func_get_args(), $pluginInfo);
        }
    }
