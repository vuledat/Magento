...
class Interceptor extends \Magento\Tax\Model\ResourceModel\TaxClass\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setClassTypeFilter');
        if (!$pluginInfo) {
            return parent::setClassTypeFilter($classTypeId);
        } else {
            return $this->___callPlugins('setClassTypeFilter', func_get_args(), $pluginInfo);
        }
    }
