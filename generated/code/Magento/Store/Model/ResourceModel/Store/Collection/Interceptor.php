...
class Interceptor extends \Magento\Store\Model\ResourceModel\Store\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setLoadDefault');
        if (!$pluginInfo) {
            return parent::setLoadDefault($loadDefault);
        } else {
            return $this->___callPlugins('setLoadDefault', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoadDefault');
        if (!$pluginInfo) {
            return parent::getLoadDefault();
        } else {
            return $this->___callPlugins('getLoadDefault', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setWithoutDefaultFilter');
        if (!$pluginInfo) {
            return parent::setWithoutDefaultFilter();
        } else {
            return $this->___callPlugins('setWithoutDefaultFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addGroupFilter');
        if (!$pluginInfo) {
            return parent::addGroupFilter($groupId);
        } else {
            return $this->___callPlugins('addGroupFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addStatusFilter($status)
    {
        ...
        if (!$pluginInfo) {
            return parent::addStatusFilter($status);
        } else {
    ...
    public function addIdFilter($store)
    {
        ...
        if (!$pluginInfo) {
            return parent::addIdFilter($store);
        } else {
    ...
    public function addWebsiteFilter($website)
    {
        ...
        if (!$pluginInfo) {
            return parent::addWebsiteFilter($website);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'loadByCategoryIds');
        if (!$pluginInfo) {
            return parent::loadByCategoryIds($categories);
        } else {
            return $this->___callPlugins('loadByCategoryIds', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRootCategoryIdAttribute');
        if (!$pluginInfo) {
            return parent::addRootCategoryIdAttribute();
        } else {
            return $this->___callPlugins('addRootCategoryIdAttribute', func_get_args(), $pluginInfo);
        }
    }
