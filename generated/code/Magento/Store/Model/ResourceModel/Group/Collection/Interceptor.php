...
class Interceptor extends \Magento\Store\Model\ResourceModel\Group\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setWithoutStoreViewFilter');
        if (!$pluginInfo) {
            return parent::setWithoutStoreViewFilter();
        } else {
            return $this->___callPlugins('setWithoutStoreViewFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setWithoutAssignedCategoryFilter');
        if (!$pluginInfo) {
            return parent::setWithoutAssignedCategoryFilter();
        } else {
            return $this->___callPlugins('setWithoutAssignedCategoryFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, '_beforeLoad');
        if (!$pluginInfo) {
            return parent::_beforeLoad();
        } else {
            return $this->___callPlugins('_beforeLoad', func_get_args(), $pluginInfo);
        }
    }
