...
class Interceptor extends \Magento\Store\Model\ResourceModel\Website\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinGroupAndStore');
        if (!$pluginInfo) {
            return parent::joinGroupAndStore();
        } else {
            return $this->___callPlugins('joinGroupAndStore', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addFilterByGroupIds');
        if (!$pluginInfo) {
            return parent::addFilterByGroupIds($groupIds);
        } else {
            return $this->___callPlugins('addFilterByGroupIds', func_get_args(), $pluginInfo);
        }
    }
