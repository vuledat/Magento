...
class Interceptor extends \Magento\Review\Model\ResourceModel\Review\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addCustomerFilter');
        if (!$pluginInfo) {
            return parent::addCustomerFilter($customerId);
        } else {
            return $this->___callPlugins('addCustomerFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addEntityFilter($entity, $pkValue)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('addEntityFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setDateOrder');
        if (!$pluginInfo) {
            return parent::setDateOrder($dir);
        } else {
            return $this->___callPlugins('setDateOrder', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addRateVotes');
        if (!$pluginInfo) {
            return parent::addRateVotes();
        } else {
            return $this->___callPlugins('addRateVotes', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addReviewsTotalCount');
        if (!$pluginInfo) {
            return parent::addReviewsTotalCount();
        } else {
            return $this->___callPlugins('addReviewsTotalCount', func_get_args(), $pluginInfo);
        }
    }
