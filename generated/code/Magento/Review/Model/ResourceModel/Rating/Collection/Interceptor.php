...
class Interceptor extends \Magento\Review\Model\ResourceModel\Rating\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addEntityFilter($entity)
    {
        ...
        if (!$pluginInfo) {
            return parent::addEntityFilter($entity);
        } else {
    ...
    public function setStoreFilter($storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::setStoreFilter($storeId);
        } else {
    ...
    public function addOptionToItems()
    {
        ...
        if (!$pluginInfo) {
            return parent::addOptionToItems();
        } else {
            return $this->___callPlugins('addOptionToItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addEntitySummaryToItem($entityPkValue, $storeId)
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('addEntitySummaryToItem', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function addRatingPerStoreName($storeId)
    {
        ...
        if (!$pluginInfo) {
            return parent::addRatingPerStoreName($storeId);
        } else {
            return $this->___callPlugins('addRatingPerStoreName', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setActiveFilter($isActive = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::setActiveFilter($isActive);
        } else {
            return $this->___callPlugins('setActiveFilter', func_get_args(), $pluginInfo);
        }
    }
