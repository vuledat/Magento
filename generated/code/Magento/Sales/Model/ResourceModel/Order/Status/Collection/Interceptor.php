...
class Interceptor extends \Magento\Sales\Model\ResourceModel\Order\Status\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'joinStates');
        if (!$pluginInfo) {
            return parent::joinStates();
        } else {
            return $this->___callPlugins('joinStates', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addStateFilter');
        if (!$pluginInfo) {
            return parent::addStateFilter($state);
        } else {
            return $this->___callPlugins('addStateFilter', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'orderByLabel');
        if (!$pluginInfo) {
            return parent::orderByLabel($dir);
        } else {
            return $this->___callPlugins('orderByLabel', func_get_args(), $pluginInfo);
        }
    }
