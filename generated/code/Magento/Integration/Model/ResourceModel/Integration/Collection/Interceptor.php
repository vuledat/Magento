...
class Interceptor extends \Magento\Integration\Model\ResourceModel\Integration\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'addUnsecureUrlsFilter');
        if (!$pluginInfo) {
            return parent::addUnsecureUrlsFilter();
        } else {
            return $this->___callPlugins('addUnsecureUrlsFilter', func_get_args(), $pluginInfo);
        }
    }
