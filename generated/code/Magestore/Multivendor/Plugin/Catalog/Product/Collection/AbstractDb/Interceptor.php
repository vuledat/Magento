<?php
namespace Magestore\Multivendor\Plugin\Catalog\Product\Collection\AbstractDb;

/**
 * Interceptor class for @see \Magestore\Multivendor\Plugin\Catalog\Product\Collection\AbstractDb
 */
class Interceptor extends \Magestore\Multivendor\Plugin\Catalog\Product\Collection\AbstractDb implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'beforeGetSize');
        if (!$pluginInfo) {
            return parent::beforeGetSize($object);
        } else {
            return $this->___callPlugins('beforeGetSize', func_get_args(), $pluginInfo);
        }
    }
