<?php
namespace Magestore\Multivendor\Model\ResourceModel\Vendor\Grid\Collection;

/**
 * Interceptor class for @see \Magestore\Multivendor\Model\ResourceModel\Vendor\Grid\Collection
 */
class Interceptor extends \Magestore\Multivendor\Model\ResourceModel\Vendor\Grid\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getAggregations()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getAggregations', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function setAggregations($aggregations)
    {
        ...
        if (!$pluginInfo) {
            return parent::setAggregations($aggregations);
        } else {
            return $this->___callPlugins('setAggregations', func_get_args(), $pluginInfo);
        }
    }
